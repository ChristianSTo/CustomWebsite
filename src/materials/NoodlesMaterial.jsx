...
const NoodlesLitMaterial = shaderMaterial(
  {
    // Color Uniforms
    uLitColor: new THREE.Color("#FFF5C5"),
    uShadeColor: new THREE.Color("#FFD8B7"),
...
extend({ NoodlesLitMaterial }); // Register the material
// Use the NoodlesLitMaterial defined above
function NoodlesMaterial({ lightPosition, ...props }) {
...
export default NoodlesMaterial;
