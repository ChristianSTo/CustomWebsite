...
const EggLitMaterial = shaderMaterial(
  {
    // Color Uniforms
    uLitColor: new THREE.Color("#FFD888"),
    uShadeColor: new THREE.Color("#FFC083"),
...
extend({ EggLitMaterial }); // Register the material
// Use the EggLitMaterial defined above
function EggMaterial({ lightPosition, ...props }) {
