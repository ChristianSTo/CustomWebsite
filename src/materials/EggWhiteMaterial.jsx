...
const EggWhiteLitMaterial = shaderMaterial(
  {
    // Color Uniforms
    uLitColor: new THREE.Color("#FFF1DC"),
    uShadeColor: new THREE.Color("#FFF1DC"),
    uHighlightColor: new THREE.Color("#FFFFFF"), // Color for highlights (Specular)
...
extend({ EggWhiteLitMaterial }); // Register the material
// Use the EggWhiteLitMaterial defined above
function EggWhiteMaterial({ lightPosition, ...props }) {
...
export default EggWhiteMaterial;
